...
kpi: {
    ...
    pieOverride: {
        '线索级别占比': {
            ...
            segments: [
                { color: '#00337c', label: 'H（试驾排程）', count: '1,481', pct: '12%', start: 0, end: 12 },
                { color: '#0052cc', label: 'H（试驾线索）', count: '1,852', pct: '15%', start: 12, end: 27 },
                { color: '#0081ff', label: 'H（非试驾线索）', count: '988', pct: '8%', start: 27, end: 35 },
                { color: '#1a75ff', label: 'A', count: '1,358', pct: '11%', start: 35, end: 46 },
                { color: '#3b82f6', label: 'B', count: '1,481', pct: '12%', start: 46, end: 58 },
                { color: '#60a5fa', label: 'C', count: '1,852', pct: '15%', start: 58, end: 73 },
                { color: '#93c5fd', label: 'F', count: '617', pct: '5%', start: 73, end: 78 },
                { color: '#bfdbfe', label: 'L', count: '494', pct: '4%', start: 78, end: 82 },
                { color: '#cfe2ff', label: 'E', count: '370', pct: '3%', start: 82, end: 85 },
...
download: {
    channelEffectDetail: {
        ...
        rows: [
            ['R1-抖音信息流', '抖音', 'N7', '2026-05-28', 'H（试驾排程）', '已接通', '45', '2026-05-29', '-', '-', '-', '张三', '138****1234'],
            ['R2-懂车帝', '懂车帝', 'N7', '2026-05-27', 'H（试驾线索）', '已接通', '32', '2026-05-28', '2026-05-29', '-', '-', '李四', '139****5678'],
            ['R3-百度竞价', '百度', 'N6', '2026-05-26', 'A', '未接通', '0', '-', '-', '-', '-', '王五', '136****9012'],
            ['R1-抖音信息流', '抖音', 'NX8', '2026-05-25', 'B', '已接通', '28', '-', '-', '-', '-', '赵六', '137****3456'],
            ['R4-快手', '快手', 'N7', '2026-05-24', 'H（非试驾线索）', '已接通', '55', '2026-05-26', '2026-05-28', '2026-05-30', '-', '孙七', '135****7890'],
            ['R5-小红书', '小红书', 'N6', '2026-05-23', 'C', '已接通', '18', '-', '-', '-', '-', '周八', '133****2345'],
            ['R2-懂车帝', '懂车帝', 'N7', '2026-05-22', 'H（试驾排程）', '已接通', '62', '2026-05-24', '2026-05-25', '2026-05-28', '2026-05-30', '吴九', '132****6789'],
            ['R6-朋友圈', '朋友圈', 'NX8', '2026-05-21', 'F', '未接通', '0', '-', '-', '-', '-', '郑十', '131****0123'],
            ['R3-百度竞价', '百度', 'N7', '2026-05-20', 'A', '已接通', '41', '2026-05-22', '-', '-', '-', '陈十一', '130****4567'],
            ['R1-抖音信息流', '抖音', 'N6', '2026-05-19', 'L', '已接通', '22', '-', '-', '-', '-', '刘十二', '129****8901'],
            ['R7-头条', '头条', 'N7', '2026-05-18', 'E', '空号', '0', '-', '-', '-', '-', '黄十三', '128****2345'],
            ['R4-快手', '快手', 'NX8', '2026-05-17', 'B', '已接通', '37', '-', '-', '-', '-', '杨十四', '127****6789'],
            ['R8-优酷', '优酷', 'N7', '2026-05-16', '无效号码', '停机', '0', '-', '-', '-', '-', '朱十五', '126****0123'],
            ['R5-小红书', '小红书', 'N6', '2026-05-15', 'H（试驾线索）', '已接通', '48', '2026-05-17', '2026-05-19', '-', '-', '马十六', '125****4567'],
            ['R2-懂车帝', '懂车帝', 'N7', '2026-05-14', 'C', '已接通', '19', '-', '-', '-', '-', '胡十七', '124****8901']
        ]
    }
},
